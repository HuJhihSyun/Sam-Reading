...
useHead({ title: '聯絡作者 — Sam\'s World' })
      ...
      <Transition name="fade" mode="out-in">
        ...
        <div v-if="sent" class="text-center py-12">
          ...
          <button
            ...
            @click="sent = false; Object.assign(form, { name: '', email: '', message: '' })"
          >
            再寫一封
          </button>
        </div>
          ...
          <form class="space-y-5" @submit.prevent="handleSubmit">
            ...
            <div>
              ...
              <input
                ...
                required
                placeholder="你的名字"
                class="w-full px-4 py-3 rounded-xl border border-petal-200 bg-petal-50/50 text-mauve-700 text-sm placeholder:text-mauve-300
                       focus:outline-none focus:border-petal-300 focus:bg-white transition-colors"
              >
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="想對我說的話……"
                class="w-full px-4 py-3 rounded-xl border border-petal-200 bg-petal-50/50 text-mauve-700 text-sm placeholder:text-mauve-300
                       focus:outline-none focus:border-petal-300 focus:bg-white transition-colors resize-none"
              />
            </div>
            ...
            <button
              type="submit"
              :disabled="submitting"
              class="w-full py-3 rounded-xl bg-petal-400 text-white text-sm font-medium tracking-wide
                     hover:bg-petal-500 active:scale-95 transition-all duration-150
